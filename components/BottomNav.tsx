...
const TAB_HREFS = ["/home", "/history", "/calendar", "/analytics"] as const;
const TAB_ICONS = [
  ...
  <svg key="calendar" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>,
...
export default function BottomNav() {
  ...
  const labels = [t.nav.home, t.nav.quotes, "Calendar", t.nav.stats];
